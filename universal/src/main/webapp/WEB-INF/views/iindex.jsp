				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="box-simple">
							...
							<h3>Guaranteed</h3>
							<p>Deliver products with waranty card delivered from our side and from Apple Store</p>
						</div>
					</div>
					<div class="col-md-4">
						<div class="box-simple">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="box-simple">
							...
							<h3>Ideas</h3>
							<p>Our team is working with innovative ideas that can satisfy customers needs and high level security provided for online purchase</p>
						</div>
					</div>
					<div class="col-md-4">
						<div class="box-simple">
							...
							<h3>Email</h3>
							<p>Contact us if you have any problems with our products easily.</p>
						</div>
					</div>
					<div class="col-md-4">
						<div class="box-simple">
							...
							<h3>Customers</h3>
							<p>Millions of customers all over the world are satisfied with our products</p>
						</div>
					</div>
				</div>
			</div>
 ...
 _________________________________________________________ -->
		...
		<div class="container">
			...
			<div class="col-md-12">
				...
				<p class="lead">
				New iPhone 7 to launch in India sooon.... 
				<span class="accent">Check our blog!</span>
				</p>
					...
					<div class="col-md-12 col-sm-6 pull-center">
						<div class="box-image-text blog">
							...
							<div class="content">
								...
								<p align="center">Look into it for some cool features of iPhone 7</p>
								<p class="read-more">
									<a href="blog" class="btn btn-template-main">Continue
										reading</a>
								</p>
							</div>
						</div>
