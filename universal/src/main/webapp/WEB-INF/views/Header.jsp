					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="social pull-left">
								...
								<a href="<c:url value ="http://www.gmail.com"/>"
						...
						<div class="col-sm-8">
							<div class="login pull-right">
								...
								<c:choose>
									...
									<c:otherwise>
										<a href="<c:url value="/"/>"><i class="fa fa-home"></i> <span
										...
										<a href="<c:url value="/register"/>"><i class="fa fa-user">
										</i> <span class="hidden-xs text-uppercase">Sign up</span></a>
									</c:otherwise>
								</c:choose>
							</div>
						</div>
					...
					<div class="container">
						<div class="navbar-header">
							...
							<a class="navbar-brand home" href="<c:url value="/"/>"> <img
								...
								alt="Apple eStore logo" class="hidden-xs hidden-sm"> <img
								src="<c:url value ="/resources/img/logo-small.png"/>"
								alt="Apple eStore logo" class="visible-xs visible-sm"> <span
						...
						<div class="navbar-collapse collapse" id="navigation">
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown"><a href="javascript: void(0)"
									...
									aria-expanded="false">My pages <b class="caret"></b></a>
