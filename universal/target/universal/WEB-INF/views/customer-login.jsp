...
<head>
    ...
    <link href="<c:url value='http://fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,500,700,800'/>" rel='stylesheet' type='text/css'/>

    <!-- Bootstrap and Font Awesome css -->
    <link rel="stylesheet" href="<c:url value='http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css'/>"/>
    <link rel="stylesheet" href="<c:url value='http://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css/'/>"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-7">
                            ...
                            <div class="login">
                                ...
                                <a href="<c:url value="customer-register.html"/>"><i class="fa fa-user"></i> <span class="hidden-xs text-uppercase">Sign up</span></a>
                            </div>
                    ...
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand home" href="index.html">
                                <img src="<c:url value="/resources/img/logo.png" />" alt="Apple logo" class="hidden-xs hidden-sm">
                                <img src="<c:url value="/resources/img/logo-small.png" />" alt="Apple logo" class="visible-xs visible-sm"><span class="sr-only">Universal - go to homepage</span>
                            </a>
...
_________________________________________________________ -->
        ...
        <div id="content">
                            ...
                            <p class="text-muted">TYPE HERE SOME THING.</p>

                            <hr>
							<!-- LOGIN FORM INSIDE CUSTOMER-REGISTER.JSP -->
            ...
            <div class="container">
                    ...
                    <div class="blog-entries">
                        <div class="item same-height-row clearfix">
                            <div class="image same-height-always">
                                <a href="#">
                                    <img class="img-responsive" src="<c:url value="img/detailsquare.jpg"/>" alt="">
                                </a>
                            </div>
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="photostream">
                        <div>
                            <a href="#">
                                <img src="<c:url value="img/detailsquare.jpg"/>" class="img-responsive" alt="#">
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <img src="<c:url value="img/detailsquare2.jpg"/>" class="img-responsive" alt="#">
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <img src="<c:url value="img/detailsquare3.jpg"/>" class="img-responsive" alt="#">
                            </a>
                        </div>
                        <div>
                            <a href="#">
...
_________________________________________________________ -->
    ...
    <script src="<c:url value="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/js/bootstrap.min.js"/>"></script>
