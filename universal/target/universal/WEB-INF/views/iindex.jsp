            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p>	<br>${selectedProduct.id}
							<br>${selectedProduct.name}
							<br>${selectedProduct.description}
							<br>Rs.${selectedProduct.price}
							<br>${selectedProduct.category.name}
							<br>${selectedProduct.supplier.name}
							<br><br><button class="btn btn-template-main">Add to Cart</button>
							<br><br>
                    ...
                    <div class="col-md-6 text-center">
                      	<img alt="" src="<c:url value="/resources/img/productImages/${selectedProduct.id}.png"/>" /> 
                    </div>
                </div>
            </div>
        </section>
